...
var Action;
(function (Action) {
    Action[Action["READY"] = 0] = "READY";
    Action[Action["SET_CONTENT"] = 1] = "SET_CONTENT";
...
function init(data) {
    ...
    editor = monaco.editor.create(document.getElementById("container"), {
        model: monaco.editor.createModel("", "myDsl", monaco.Uri.parse("https://git.informatik.tu-cottbus.de/schubmat/monaco-client/raw/master/demo/a.mydsl")),
        glyphMargin: true,
        lightbulb: {
            enabled: true
        },
