...
import {Setable, withProps} from "./with";
import {useGitAccounts} from "./GitAccounts";
import {State} from "../model/stateEntity";
import {useProjectVersion} from "./ProjectVersion";
...
const EditGitContext = React.createContext<EditGitConnection | null>(null);
